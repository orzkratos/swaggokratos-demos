...
func NewGRPCServer(c *conf.Server, greeter *service.GreeterService, myHomepageService *service.MyhomepageService, logger log.Logger) *grpc.Server {
	...
	myhomepage.RegisterMyhomepageServer(srv, myHomepageService)
	return srv
}
